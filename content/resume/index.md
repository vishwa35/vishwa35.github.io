...
- Pitched and started the groundwork for a podcast targeting young Jains in the US, with the mission of bringing current perspectives to the forefront of discussion and shedding light on niche topics affecting the community
- Lead a team of 5 to develop content, interview people, and storyboard
...
**Programming**: <a class=tag__link>Java</a> <a class=tag__link>Python</a> <a class=tag__link>SQL</a> <a class=tag__link>Ruby</a> <a class=tag__link>C++</a> <a class=tag__link>C#</a> <a class=tag__link>JavaScript</a> <a class=tag__link>MongoDB</a>

**Languages**: Spanish (conversational), Hindi (fluent), Gujarati (fluent), English (native)
